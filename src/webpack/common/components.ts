...
export const Calendar = waitForComponent<t.Calendar>("Calendar", filters.componentByCode('"data-mana-component":"calendar"'));

export const DatePicker = waitForComponent<t.DatePicker>("DatePicker", filters.componentByCode('"data-mana-component":"date-picker"'));
