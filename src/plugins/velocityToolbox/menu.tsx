...
import { CMIconClasses, Icons, Menu, showToast, useMemo, useState } from "@webpack/common";
...
function buildPluginMenu() {
    ...
    return (
        <Menu.MenuItem
            id="plugins"
            label="Plugins"
            action={() => openSettingsTabModal(PluginsTab, ModalSize.LARGE)}
        >
            {pluginEntries}
        </Menu.MenuItem>
    );
                            ...
                            {hasVisibleOptions && (
                                <>
                                    ...
                                    <Menu.MenuItem
                                        ...
                                        leadingAccessory={{
                                            type: "icon",
                                            icon: () => <Icons.SettingsIcon size="refresh_sm" className={CMIconClasses.icon} />
                                        }}
                                        icon={<Icons.SettingsIcon size="refresh_sm" className={CMIconClasses.icon} />}
                                        action={() => openPluginModal(p)}
                                    />
