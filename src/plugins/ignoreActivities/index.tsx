...
import { Buttons, FluxDispatcher, Menu, RunningGameStore, showToast, Text, TextInput, Toasts, Tooltip, useEffect, useState } from "@webpack/common";
...
function ImportCustomRPCComponent() {
    return (
        <Flex flexDirection="column">
            <Text>Import the application id of the CustomRPC plugin to the filter list</Text>
            <div>
                <Buttons.Button
