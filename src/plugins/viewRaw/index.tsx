...
import { Buttons, ChannelStore, CMIconClasses, Forms, GuildRoleStore, Icons, Menu, PopoverClasses, Text } from "@webpack/common";
    ...
    const key = openModal(props => (
        <ErrorBoundary>
            <ModalRoot {...props} size={ModalSize.LARGE}>
                    ...
                    <div style={{ padding: "16px 0" }}>
                        {!!msgContent && (
                            <>
                                ...
                                <CodeBlock className="vc-codeblock" content={msgContent} />
                ...
                <ModalFooter>
                    <Buttons.ButtonGroup direction="horizontal" gap="8" justify="end">
                        <Buttons.Button
