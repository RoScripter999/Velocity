...
import type { DiscordLocale, Guild, Role, UnicodeEmoji, User } from "@velocity-types";
import { findByCodeLazy } from "@webpack";
import { Buttons, ContextMenuApi, FlexClasses, FluxDispatcher, Forms, GuildMemberStore, GuildRoleStore, Icons, IconUtils, Menu, RichTooltip, ScrollerThin, SearchBar, Text, useEffect, useMemo, useRef, UserStore, useState, useStateFromStores } from "@webpack/common";
...
function RolesAndUsersPermissionsComponent({ permissions, guild, modalProps, header, userId }: { permissions: Array<RoleOrUserPermission>; guild: Guild; modalProps: ModalProps; header: string; userId?: string; }) {
    ...
    return (
        <ModalRoot {...modalProps} size={ModalSize.LARGE}>
            <ModalHeader direction={FlexClasses.Direction.VERTICAL} align={FlexClasses.Align.STRETCH}>
