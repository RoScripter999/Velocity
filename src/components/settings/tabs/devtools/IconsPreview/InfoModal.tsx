...
import { ModalCloseButton, ModalContent, ModalFooter, ModalHeader, type ModalProps, ModalRoot, ModalSize, openModalLazy } from "@utils/modal";
import { Buttons, Forms, Slider, Text, useMemo, useState } from "@webpack/common";
        ...
        <ModalRoot {...modalProps} size={ModalSize.MEDIUM}>
            ...
            <ModalContent className={cl("content")}>
                <Card className={cl("preview-card")}>
                    <SectionHeader title="Preview" titleVariant="text-sm/semibold" description={`${Math.round(size)}px`} descriptionVariant="text-xs/normal" descriptionColor="text-muted" className={Margins.bottom16} />
                    ...
                    <Flex alignItems="center" justifyContent="center" className={cl("preview-area")}>
