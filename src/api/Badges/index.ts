...
import type { ComponentType, HTMLProps, JSX } from "react";
 ...
 * @returns modalKey
 */
export function openBadgesModal(userInfo: Omit<BadgeUserArgs, "guildId">) {
    return openModal(props => BadgesModal(props, { ...userInfo, guildId: "" }));
}
