...
import { Avatar, Buttons, FlexClasses, Forms, Icons, IconUtils, Text, UserStore } from "@webpack/common";
...
export function BadgesModal(modalProps: ModalProps, args: BadgeUserArgs) {
