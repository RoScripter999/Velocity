...
import { closeModal, ModalCloseButton, ModalFooter, ModalHeader, type ModalProps, ModalRoot, ModalSize, openModal } from "@utils/modal";
import { useAwaiter } from "@utils/react";
import { Alerts, Buttons, ListScrollerThin, Text, Timestamp, useEffect, useReducer, useState } from "@webpack/common";
...
function LogModal({ modalProps, close }: { modalProps: ModalProps; close(): void; }) {
    ...
    return (
        <ModalRoot {...modalProps} size={ModalSize.LARGE} className={cl("modal")}>
            ...
            <ModalFooter>
                <Flex>
                    <Buttons.Button text="Notification Settings" onClick={openNotificationSettingsModal} />
