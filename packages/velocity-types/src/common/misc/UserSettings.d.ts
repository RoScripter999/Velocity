...
export interface SidebarItemNode extends LayoutNode, BadgesNode {
    ...
    /**
     * Creates a submenu in {@link SidebarItemNode this} node's menu that is in settings-menu context.
     * Only allows Menu Items and groups of Items as children.
     */
    useMenu?(): ReactNode;
...
export interface CategoryNode extends LayoutNode, BadgesNode {
